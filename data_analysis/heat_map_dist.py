...
fig, ((ax1, ax2), (ax3, ax4)) = plt.subplots(2, 2, figsize=(9.1, 8.75))
...
ax1.annotate('Low aggregation preference - CBF (Ours)', xy=(0.025, 0.025), xycoords='axes fraction', fontsize=12,
             ha='left', va='bottom', color='white')  # Add annotation at the left bottom
ax2.annotate('Low aggregation preference - Outmost Push', xy=(0.025, 0.025), xycoords='axes fraction', fontsize=12,
             ha='left', va='bottom', color='white')  # Add annotation at the left bottom
ax3.annotate('High aggregation preference - CBF (Ours)', xy=(0.025, 0.025), xycoords='axes fraction', fontsize=12,
             ha='left', va='bottom', color='white')  # Add annotation at the left bottom
ax4.annotate('High aggregation preference - Outmost Push', xy=(0.025, 0.025), xycoords='axes fraction', fontsize=12,
             ha='left', va='bottom', color='white')  # Add annotation at the left bottom
